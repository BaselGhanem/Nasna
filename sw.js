const cacheName = `nasna-shell-v11`;
const shellFiles = [
  `./`,
  `./index.html`,
  `./styles.css`,
  `./app.js?v=20260725.7`,
  `./firebase-config.js?v=20260725.7`,
  `./firestore-config.js?v=20260725.7`,
  `./dashboard.html`,
  `./dashboard.css?v=20260725.7`,
  `./dashboard.js?v=20260725.7`,
  `./organization.html`,
  `./organization.css?v=20260725.7`,
  `./organization.js?v=20260725.7`,
  `./structure.html`,
  `./structure.css?v=20260725.7`,
  `./structure.js?v=20260725.7`,
